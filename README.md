...
```
2026 Apr — Present     Software Engineer 1, HashedIn by Deloitte
2026 Jan — Apr         Software Engineering Intern, HashedIn by Deloitte
                        → Built 35+ backend APIs for "Vault", an internal platform
                          adopted across 100% of dev projects org-wide
2025 May — Jul          Associate Software Engineering Intern, Accenture
                        → Time-series revenue forecasting in SAP Analytics Cloud
                          95% accuracy (MAPE 5.01%)
2024 Aug — 2025 Apr     Software Engineering Intern, Samsung
                        → Deep learning document enhancement (DocRes, NAFNet)
...
| Project | Highlights |
|---|---|
| **[Multimodal Video Summarizer](https://github.com/kartik99kumar1/Multimodal-Video-Summarizer)** | Whisper + BART pipeline · 85% summarization accuracy · 50% duration reduction with preserved narrative |
